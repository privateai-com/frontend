              ...
              <InfoTableRow
                props={{
                  ...
                  info: !article?.isPublic ? <>
                    {
                      article?.status === 'Access request pending' &&  <span className={cx(styles.accessRequestPendingStatus,styles.status_span)}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path d="M19 10C19 14.9706 14.9706 19 10 19C5.02944 19 1 14.9706 1 10C1 5.02944 5.02944 1 10 1C14.9706 1 19 5.02944 19 10Z" stroke="#7C859E" stroke-width="2"/>
                          <path d="M10 5L10 9.5L10 9.51955C10 9.81971 10.15 10.1 10.3998 10.2665V10.2665L13 12" stroke="#7C859E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Access request pending
                      </span>
                    }
                    {
                      article?.status === 'Permission needed' &&  <span className={cx(styles.permissionNeededStatus,styles.status_span)}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M12 8L12 13" stroke="#E0A32C" stroke-width="2" stroke-linecap="round"/>
                          <path d="M12 16V15.9888" stroke="#E0A32C" stroke-width="2" stroke-linecap="round"/>
                          <path d="M3 12C3 4.5885 4.5885 3 12 3C19.4115 3 21 4.5885 21 12C21 19.4115 19.4115 21 12 21C4.5885 21 3 19.4115 3 12Z" stroke="#E0A32C" stroke-width="2"/>
                        </svg>
                        Permission needed
                      </span>
                    }
                    {
                      article?.status === 'Access granted' &&  <span className={cx(styles.accessGrantedStatus,styles.status_span)}>
