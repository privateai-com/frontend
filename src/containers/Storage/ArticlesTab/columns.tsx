            ...
            <div className={styles.availability} key={`div-${id}-${isPublic}`}>
              ...
              <MultiDrop props={{
                ...
                btnList: [
                  ...
                  //     <path 
                  // d="M3 12C3 4.5885 4.5885 3 12 3C19.4115 3 21 4.5885 21 12C21 
                  // 19.4115 19.4115 21 12 21C4.5885 21 3 19.4115 3 12Z" 
                  // stroke="#BDC2CF" stroke-width="2"/>
                  //     <path d="M12 15.5356L12 7.75739" stroke="#BDC2CF" stroke-width="2" 
                  // troke-linecap="round" stroke-linejoin="round"/>
                  // <path 
                  //   d="M15.5355 12.7071L12.2322 16.0105C12.1039 16.1387 
                  // 11.896 16.1387 11.7678 16.0104L8.46447 12.7071" 
                  //   stroke="#BDC2CF" stroke-width="2" 
