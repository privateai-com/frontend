      ...
      <div className={styles.main}>
        <div className={styles.main_wrapper}>
          ...
          <div className={styles.main_text}>
            ...
            the Archon team. In today&apos;s digital landscape, where data
            breaches and unauthorized access are prevalent, implementing robust
            security mechanisms is crucial. Archon employs a multi-layered
            approach to safeguard user data, with a focus on three main
            mechanisms:
            <ul>
              <br />
              <li>
                ...
                authorized users. When a user uploads a file to the Archon
                system, it undergoes encryption using RSA. This means that even
                if an unauthorized party gains access to the encrypted files,
                they would be unable to decipher the content. (RSA)
                {' '}
              </li>
              <li>
          ...
          <div className={styles.main_text}>
            ...
            itself. According to 
            {' '}
            <a href="https://#.com">wikipedia</a>
            ,
            {' '}
            <strong>encryption</strong>
            {' '}
            is the process that converts the
            original representation of the information, known as plaintext, into
            an alternative form known as ciphertext. The goal is to let only
            ...
            both encrypt and decrypt the information, i.e. sender and recipient
            use the same key. It is presented on the schemes below. In case Bob
            wants to transfer a file to Alice, they should beforehand somehow
            agree on which encryption key to use and keep it in secret. After
            the agreement is achieved, both parties can encrypt and decrypt
            messages for and from the other party using the same key.
          </div>
            ...
            <div className={styles.main_text}>
              ...
              <ul>
                <li>
                  ...
                  distribute the encryption key before they can use the system.
          ...
          <div className={styles.main_text}>
            Unlike the symmetric protocols, the asymmetric type of encryption
            does not involve the aforementioned problems and therefore it is a
            ...
            the encrypting of the information, so one can always take any public
            key and encrypt data for the corresponding user. However, since the
            private key is needed for decrypting the data, only the intended
            recipient who possesses the corresponding private key can decrypt
          ...
          <div className={styles.main_block_halfed}>
            <div className={styles.main_text}>
              ...
              public key, encode the message with it and send it to Alice via an
              insecure channel. A message can be intercepted, but no one can
              decrypt the data besides Alice, because she is the only one who
              possesses the private key. So her only necessity is to keep the
              private key and not share it with anybody.
              <br />
              <br />
            ...
            <div className={styles.main_img_block}>
              <Image
                src={getImage(SharedKey, SharedKey, SharedKeyMob)}
                alt="Shared Key"
              />
            </div>
          </div>
          <div className={styles.main_block_halfed}>
            <div className={styles.main_text}>
              ...
              most common types of attack called “Man in the middle” by allowing
              the creation of digital signatures. This attack type denotes a
              situation when the attacker intercepts the messages from the
              sender, modifies them, and sends further to the recipient
              pretending to be the sender. In other words, two parties
              communicate not with each other but with an unauthorized user
              without even knowing it. Digital signature prevents malicious
              behavior, because it implies a mechanism where all messages are
              signed with the sender’s private key, therefore the recipient can
              always verify the sender’s identity. More information about
            ...
            <div className={styles.main_img_block}>
              <div className={styles.main_imgs_block}>
                ...
                />
                <Image
                  src={getImage(PrivateKey, PrivateKeyTablet, PrivateKeyMob)}
                  alt="Asymetric Encryption"
                />
              </div>
            </div>
          ...
          <div className={styles.main_text}>
            ...
            protocol RSA which is based on the task of factoring the product of
            two large prime numbers that is also known as the &quot;factoring
            problem&quot;. Without going deep into math details, we’d say that
            it is extremely difficult to guess two prime numbers which result in
            the given large number after multiplication. The explanations of its
            complexity and the approximate brute-force break times can be found
            here:
            <ul>
              <br />
          ...
          <div className={styles.main_text}>
            ...
            feature known as multikey encryption ?. This serves as a complement
            to asymmetric protocols and enables the encryption of a file with
          ...
          <div className={styles.main_text}>
            ...
            system generates the file encryption key pair and encodes the
            private key with the key password. Therefore, the private key is
            also stored in the encrypted form and cannot be used by an attacker
            even if it was compromised.
            <br /> 
            {' '}
            <br />
          ...
          <div className={styles.main_text}>
            ...
            transferring the keys manually, the system will do it instead of him
            internally.
            <br />
            {' '}
            ...
            and login password. The user will be asked to enter the key password
            as an extra approval that he is the owner of the account.
            <br /> 
            {' '}
            <br />
            {' '}
            ...
            <ul>
              <li>
                ...
                called Vault. It will increase the security and privacy of
                private keys as well as the security of the system in general;
              </li>
              <li>
              ...
              <li>
                ...
                format for the key password, it will not be a random or
          ...
          <div className={styles.main_text}>
            ...
            it is the secure storing and monitoring of the users’ encryption
            keys whose concepts and usage were described in previous sections (
            <span>
              <a href="https://#.com">link1</a>
              {' '}
              and
            ...
            concept also implements the idea that each service should be
          ...
          <div className={styles.main_text}>
            ...
            <br />
            {' '}
            HashiCorp takes security seriously and actively works
            to address any vulnerabilities that may arise. The open-source
            nature of HashiCorp allows for transparency, enabling users and
            specialists to review the code and identify any potential security
            issues. Moreover, it periodically undergoes audits from professional
            audit teams and confirms its commitment to reliability.
            <br /> 
            {' '}
            <br />
            {' '}
            ...
            solution to protect sensitive data in modern computing environments.
            Archon integrates it for secure storing of the users&apos;
            encryption key at the current stage of the project development as a
            strong and reliable tool, but it also opens huge possibilities for
            further security system upgrade, complication and optimization.
            <br /> 
            {' '}
            <br />
            {' '}
            These principles and much more are described in detail
