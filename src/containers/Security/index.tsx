        ...
        <div className={styles.main_wrapper}>
          <div className={styles.main_content}>
            ...
            <div className={styles.main_text}>
              ...
              robust security mechanisms is crucial. Archon employs a
              multi-layered approach to safeguard user data, with a focus on
              ...
              <ul>
                ...
                <li>
                  ...
                  protocol that permits to encrypt all the files stored within
                  the Archon system and provide access to it only to its owner
            ...
            <div className={styles.main_text}>
              ...
              <a href="https://#.com">wikipedia</a>, <strong>encryption</strong>{' '}
              is the process that converts the original representation of the
              information, known as plaintext, into an alternative form known as
              ciphertext. The goal is to let only authorized parties decrypt the
              ciphertext and get access to the valuable original information. In
              general, most encryption protocols can be divided into two groups
              ...
              beforehand somehow agree on which encryption key to use and keep
              it in secret. After the agreement is achieved, both parties can
              encrypt and decrypt messages for and from the other party using
              the same key.
            </div>
