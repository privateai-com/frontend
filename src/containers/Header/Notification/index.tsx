...
const Notification = forwardRef<HTMLDivElement, NotificationProps>((
  ...
  ref,
    ...
    <div className={cx(styles.bg, { [styles.show]: isOpen } )}></div>
        ...
        <div className={styles.notification_container_head}>
          ...
          <button onClick={toggleFun} className={styles.notification_container_head_close}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <path d="M1 1L15 15" stroke="#7C859E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M15 1L1 15" stroke="#7C859E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </button>
        </div>
