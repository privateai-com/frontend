...
export const Registration = () => {
  ...
  return (
    <>
     <Link href='/' className="logo" style={{position: 'absolute', textDecoration:'none', left:30, top:30, display:'flex', gap: 10, alignItems:'center', fontSize: 22, fontWeight: 500 , color:'#4659FE'}}>
    ...
    <div className="footer" style={{position: 'absolute', left:30, bottom:30}}>
      <p style={{color: '#7C859E', fontSize: 12, fontStyle: 'normal', fontWeight: 400}}>
      Web3 Foundation LLC. 2024<br /> All rights reserved.
      </p>
    </div>
